...
public class PreviewQuad {
    ...
    public void draw(CameraPreviewProgram squareProgram){
        ...
        glEnableVertexAttribArray(squareProgram.getPositionAttributeLocation());
        checkGlError("glEnableVertexAttribArray position");
        ...
        glEnableVertexAttribArray(squareProgram.getTexCoordAttributeLocation());
        checkGlError("glEnableVertexAttribArray UV");
